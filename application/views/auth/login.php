...
<div class="container">
    <h1 class="text-info text-center mt-5 pt-4 mx-md-5 display-4 pb-3" style="border-bottom:3px solid #dcdcdc">SANTA</h1>
...
<?php echo form_close();?><div class='fixed-bottom m-3'style="text-align:center" >
     <small style='color:#bbb;' style="" >All Rights Reserved &copy 2018 Santa Inc.</small>
    </body>
</div>
